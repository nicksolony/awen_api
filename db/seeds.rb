...
# Job.create(
# [
    # {position:'Freelance Graphic Designer', from:'2021-08-01', desc:'create all graphic things', current:1, show:1, company:'Avelo Airlines',user_id:1},
        # {position:'Freelance Graphic Designer', from:'2006-09-01', desc:'create all graphic things', current:1, show:1, company:'Self-employed',user_id:1},
        # {position:'Graphic Designer', from:'2005-01-01', to:'2006-09-01', desc:'create all graphic things', current:0, show:1, company:'Kaykov Media',user_id:1}
    # ]
# );
